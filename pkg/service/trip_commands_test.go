...
func TestCapabilityRegistryForIsDeterministicAndDynamic(t *testing.T) {
	...
	const wantWithoutDynamic = "cap:ext:nav:keycard:usb:time:config:status:alarm:ltc:pm:dbc:ota:settings"
	...
	const wantWithDynamic = "cap:ext:nav:keycard:usb:time:config:status:alarm:ltc:ble:pm:dbc:ota:settings:trip"

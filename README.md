...
`cap:ext` reports `keycard=2` for physical-card commands, phone management,
master-card listing and credential names. Bluetooth-service forwards these
`keycard:*` commands to the bundled keycard-service.
